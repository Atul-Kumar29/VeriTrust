      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 text-center pb-24">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 bg-gradient-to-r from-white via-indigo-100 to-indigo-400 bg-clip-text text-transparent drop-shadow-sm">
            Verifiable Video <br className="hidden md:block"/> Authenticity
          </h1>
          <p className="text-lg md:text-xl text-neutral-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            A decentralized trust layer for detecting edited and AI-generated videos. Built for transparency, powered by cryptography.
          </p>
        ...
        >
          {[
            ...
            },
            {
              ...
              desc: "We extract a unique cryptographic fingerprint anchored to the blockchain."
            },
            {
              icon: Activity,
              title: "3. Verify Authenticity",
              desc: "AI analysis detects edits, tampering, or AI generation in seconds with high accuracy."
            }
          ].map((item, i) => (
            <motion.div 
              key={i}
